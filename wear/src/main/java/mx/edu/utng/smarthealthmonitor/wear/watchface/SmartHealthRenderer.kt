package mx.edu.utng.smarthealthmonitor.wear.watchface
...
import mx.edu.utng.smarthealthmonitor.wear.presentation.WearDataStore
...
class SmartHealthRenderer(
    ...
    CanvasType.SOFTWARE, interactiveDrawModeUpdateDelayMillis, false
) {
    ...
    override fun render(
        ...
        val fc = WearDataStore.fcFlow.value
        if (fc > 0) {
            val fcStr = "❤ $fc bpm"
